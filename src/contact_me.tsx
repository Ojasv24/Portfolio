  ...
  return (
    <div className=" bg-black px-20 py-10 max-sm:p-2">
      <div className="flex flex-row justify-center max-lg:flex-col">
        ...
        <a
          href=""
          className=" ml-8 flex w-max items-center gap-x-4 rounded-4xl border-4 border-gray2 bg-gray2 p-2 transition-all duration-500 hover:border-purple1 max-lg:ml-0 max-lg:w-max "
        >
